    ...
    <>
      ...
      <div className="w-full px-2 sm:px-4 md:px-6 lg:px-8">
        <nav className="flex items-center justify-between py-1.5 md:py-2">
          <div className="flex items-center justify-center flex-wrap gap-1 sm:gap-2 md:gap-3 lg:gap-4 xl:gap-6 flex-1">
            {navItems.map((item) => {
            ...
            {user ? (
              ...
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-white text-emerald-600 rounded-full font-bold text-xs md:text-sm hover:bg-emerald-50 transition-all active:scale-95 whitespace-nowrap"
                >
                  <span>Painel</span>
                </button>
                <button
                  onClick={handleLogout}
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-red-500 text-white rounded-full font-bold text-xs md:text-sm hover:bg-red-600 transition-all active:scale-95 whitespace-nowrap"
                >
              ...
              <>
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-white text-emerald-600 rounded-full font-bold text-xs md:text-sm hover:bg-emerald-50 transition-all active:scale-95 whitespace-nowrap"
                >
                  <UserPlus className="w-3.5 h-3.5 md:w-4 md:h-4" strokeWidth={2.5} />
                  <span className="hidden sm:inline">Cadastrar</span>
                </button>
                <button
                  onClick={handleOpenLogin}
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-800 text-white rounded-full font-bold text-xs md:text-sm hover:bg-emerald-900 transition-all active:scale-95 whitespace-nowrap"
                >
